...
func Style() gs.CSSRule {
	return gs.S(BaseClass,
		...
		gs.P("background", themes.Default.BorderColorSplit),
		gs.S("&",
			gs.P("margin", " 0 8px"),
		...
		gs.S("&"+WithText,
			...
			gs.S("&:before",
				...
				gs.P("top", "50%"),
				gs.P("width", "50%"),
				gs.P("border-top", "1px solid "+themes.Default.BorderColorSplit),
			),
			gs.S("&:after",
				gs.P("content", `''`),
				gs.P("display", "table-cell"),
		...
		gs.S("&"+Dashed,
			...
			gs.P("border-top", "1px dashed "+themes.Default.BorderColorSplit),
		),
